...
var _VirtualDom_init = F4(
	function (virtualNode, flagDecoder, debugMetadata, args) {
	...
	F4(function (impl, flagDecoder, debugMetadata, args) {
		return _Platform_initialize(
			...
			//*/
				...
				import.meta.hot.data.doUpdate = _Browser_makeAnimator(
					initialModel,
					function (model) {
						var nextNode = import.meta.hot.data.view(model);
...
function _Browser_makeAnimator(model, draw) {
	...
	return function (nextModel, isSync) {
		import.meta.hot.data.currentModel = nextModel;
		model = nextModel;
...
var $elm$html$Html$Attributes$type_ =
	$elm$html$Html$Attributes$stringProperty("type");
...
import.meta.hot.accept((mod) => {
	import.meta.hot.data.view = $author$project$Main$view;
	const { view, currentModel, doUpdate } = import.meta.hot.data;
	doUpdate(currentModel, view);
});
